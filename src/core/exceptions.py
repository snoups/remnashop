...
class PromocodePlanMismatchError(PromocodeError): ...


class PromocodeAudienceMismatchError(PromocodeError): ...


class PromocodeInvalidDiscountError(PromocodeError): ...


class PromocodeInvalidMaxActivationsError(PromocodeError): ...
