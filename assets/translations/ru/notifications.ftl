...
ntf-importer-started = <i>✅ Импорт пользователей запущен, ожидайте...</i>
ntf-importer-searching = <i>🔍 Поиск подходящих пользователей, ожидайте...</i>
ntf-importer-users-not-found = <i>❌ Не удалось найти подходящих пользователей.</i>